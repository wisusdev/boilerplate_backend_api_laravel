                ...
                <div class="card mb-4">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <div id="content" style="min-height: 300px; background: white;">{{ old('content') }}</div>                            <input type="hidden" name="content" id="content_input" value="{{ old('content') }}">                            @error('content')
            ...
            <div class="col-lg-4">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" id="allow_comments" name="allow_comments" value="1" {{ old('allow_comments', true) ? 'checked' : '' }}>
                        ...
                        <div class="d-grid gap-2">
                            <button type="submit" class="btn btn-primary">
                                <i class="bi bi-check-lg"></i> {{ __('Create Post') }}
                            </button>
                        </div>
                    </div>
                </div>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body" style="max-height: 200px; overflow-y: auto;">
                        @foreach($categories as $category)
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" id="category_{{ $category->id }}" name="categories[]" value="{{ $category->id }}" {{ in_array($category->id, old('categories', [])) ? 'checked' : '' }}>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Load existing content from hidden input (for validation errors)
    ...
    const tagsJson = document.getElementById('tags_json');
    let tags = [];
    ...
    document.getElementById('selectImageBtn').addEventListener('click', function() {
        MediaSelector_postFeaturedImageModal.show(function(media) {
            ...
            const cardBody = featuredImageInput.parentElement.parentElement;
            const existingPreview = cardBody.querySelector('img');
            
            if (existingPreview) {
                existingPreview.src = media.url;
            } else {
                const newImg = document.createElement('img');
                newImg.src = media.url;
                newImg.alt = '';
                newImg.className = 'img-fluid rounded mb-3';
                cardBody.insertBefore(newImg, featuredImageInput.parentElement);
            }
        });
    });
});
