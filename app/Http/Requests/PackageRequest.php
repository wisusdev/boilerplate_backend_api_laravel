...
class PackageRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'data.attributes.limits' => ['required', 'json'],
    ...
    public function messages(): array
    {
        return [
            ...
            'data.attributes.limits.required' => 'The data.attributes.limits field is required.',
            'data.attributes.limits.json' => 'The data.attributes.limits field must be a valid JSON string.',
